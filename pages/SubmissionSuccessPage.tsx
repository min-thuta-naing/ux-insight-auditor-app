        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <button onClick={() => navigate('/')} className="mt-4 text-student-500 font-bold">Return Home</button>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-10 text-center border border-slate-100">
                ...
                <div className="flex flex-col gap-3">
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-2 py-3 bg-student-500 text-white rounded-xl hover:bg-student-600 font-bold shadow-lg transition-all active:scale-95 disabled:opacity-70"
                    >
                        {loading ? (
