            ...
            <div className="max-w-2xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    <div className="flex items-center gap-4">
                        <button
                            onClick={() => navigate(-1)}
                            className="p-2 bg-white text-slate-600 rounded-3xl border border-[#D4C9BE] hover:bg-slate-50 transition-all shadow-sm group"
                            title="Go Back"
                        >
                ...
                <div className="bg-white rounded-3xl border border-[#D4C9BE] p-8 shadow-sm">
                    <div className="flex items-center gap-6 mb-10">
                        <div className="w-20 h-20 bg-student-500 rounded-full flex items-center justify-center text-3xl text-white font-bold">
                            {initials}
                        </div>
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 bg-slate-50 border border-[#D4C9BE] rounded-3xl focus:ring-2 focus:ring-student-500 outline-none transition-all"
                                        placeholder="John"
                                    />
                                </div>
                                <div>
                            ...
                            <div className="pt-4 flex gap-4">
                                {profile && (
                                    <button
                                        ...
                                        disabled={saving}
                                        className="flex-1 py-3 px-6 bg-white text-slate-600 font-bold rounded-3xl hover:bg-slate-50 transition-all border border-[#D4C9BE] disabled:opacity-50"
                                    >
                                        Cancel
                                    </button>
                                )}
                                <button
                                    onClick={handleSave}
                                    disabled={saving}
                                    className="flex-1 py-3 px-6 bg-student-500 text-white font-bold rounded-3xl hover:bg-student-600 transition-all shadow-lg shadow-student-100 disabled:opacity-50 flex items-center justify-center gap-2"
                                >
                                    {saving ? (
                                        <>
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="bg-slate-50 px-4 py-3 rounded-3xl border border-[#D4C9BE] text-slate-700 font-medium">
                            ...
                            <div className="pt-4 flex gap-4">
                                <button
                                    ...
                                    className="flex-1 py-3 px-6 bg-student-500 text-white font-bold rounded-3xl hover:bg-student-600 transition-all border border-[#D4C9BE]"
                                >
                                    Edit Profile
                                </button>
                            </div>
